        ...
        <table class="table table-bordered">
            <thead>
                ...
                <tr>
                    ...
                    <th>
                        <a href="http://{$smarty.server.HTTP_HOST}{$subdir}Product/editForm/{$id}">Edit</a>
                    </th>
                    <th>
                        <a href="http://{$smarty.server.HTTP_HOST}{$subdir}Product/delete/{$id}">usuń</a>
                    </th>
                </tr>
                {/foreach}
            </thead>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="http://{$smarty.server.HTTP_HOST}{$subdir}Product/add" method="post" id="productForm">
...
<script src="http://{$smarty.server.HTTP_HOST}{$subdir}js/ProductFormCheck.js"></script>
</body>
</html>